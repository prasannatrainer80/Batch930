...
import { VetIntakeEditComponent } from './vet-intake-edit/vet-intake-edit.component';
import { VetIntakeAddComponent } from './vet-intake-add/vet-intake-add.component';
@Component({
  selector: 'app-vet-intakes',
  templateUrl: './vet-intakes.component.html',
  styleUrls: ['./vet-intakes.component.scss']
})
export class VetIntakesComponent
  ...
  addNew() {
    ...
    const dialogRef = this.dialog.open(VetIntakeAddComponent, {
      maxWidth: '118vw',
      maxHeight: '118vh',
      height: '95%',
      width: '95%',
  ...
  IntakeEdit(row: any) {
    const dialogRef = this.dialog.open(VetIntakeEditComponent, {
      maxWidth: '118vw',
      maxHeight: '118vh',
      height: '95%',
      width: '95%',
