...
@Component({
  selector: 'app-elicos-intake-edit',
  templateUrl: './elicos-intake-edit.component.html',
  styleUrls: ['./elicos-intake-edit.component.scss']
})
export class ElicosIntakeEditComponent {
  ...
  constructor(private _api: APICallService,
    public dialogRef: MatDialogRef<ElicosIntakeEditComponent>, private datePipe: DatePipe,
    ...
    this.dialogTitle = `Update ELICOS Intake - Course :${this.editInfo.coursename} (${this.editInfo.coursecode}) `;
  }
  ngOnInit() {
    this.loadOrigins();
  }
