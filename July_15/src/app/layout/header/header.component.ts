...
import { SwitchRoleComponent } from 'app/users/switchrole/switchrole.component';
...
export class HeaderComponent
  ...
  ngOnInit() {
    ...
    // TODO: set Home Page link and User Image
    ...
    try {
      this.hasRolesSwitch = JSON.parse(this.authService.currentUserValue.roleList)?.length > 1;
    } catch (e) { }
  ...
  SwitchRole() {
    const dialogStatusRef = this.dialog.open(SwitchRoleComponent, {
      width: 500 + 'px',
      disableClose: false,
    });
